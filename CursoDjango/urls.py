...
urlpatterns = [
    ...
    path('gesAlumnos/', HomeView.gesAlumnos, name='gesAlumnos'),
    path('gesMaestros/', HomeView.gesMaestros, name='gesMaestros'),
    path('gesClases/', HomeView.gesClases, name='gesClases'),
    path('gesAsigancion/', HomeView.gesAsignacion, name='gesAsignacion'),
]
